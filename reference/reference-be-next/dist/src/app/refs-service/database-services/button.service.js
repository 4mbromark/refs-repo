...
const button_dao_1 = require("../../refs-dao/button.dao");
let ButtonService = class ButtonService {
    ...
    getButtonById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.buttonDao.getButtonById(id);
        });
    }
    getButtonListByIdBoardAndIds(idBoard, ids) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.buttonDao.getButtonListByIdBoardAndIds(idBoard, ids);
        });
    }
};
ButtonService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [button_dao_1.ButtonDao])
], ButtonService);
